...
testArea.addEventListener_keyup (fun e -> dispatcher.Post (TextUpdated !!(e.target?value)) |> ignore)
testArea.addEventListener_keypress (fun _ -> dispatcher.Post (KeyPress) |> ignore)
